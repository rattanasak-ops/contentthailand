  ...
  return (
    ...
    >
      ...
      <div className="aspect-video bg-gradient-to-br from-purple/20 to-navy relative overflow-hidden">
        ...
        {/* Channel badge */}
        {series.channel && (
          <div className="absolute top-2 left-2 px-2 py-0.5 bg-navy/80 text-white/70 text-[10px] rounded font-thai backdrop-blur-sm">
            {series.channel}
          </div>
        )}
        ...
        {/* Hover overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-midnight via-midnight/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-3">
          {synopsis && (
